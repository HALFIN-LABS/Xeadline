      ...
      <div className="px-6 py-4 relative">
        ...
        <div className="mt-16">
          <div className="flex items-center">
            ...
            {isVerified && (
              <span className="ml-2 text-blue-500" title="NIP-05 Verified">
          ...
          {nip05 && (
            <div className="flex items-center text-gray-600 dark:text-gray-400 mt-1">
              ...
              <span className="ml-1 text-xs bg-blue-100 text-blue-800 dark:bg-blue-900 dark:text-blue-300 px-2 py-0.5 rounded-full">
                Verified
              </span>
            </div>
          )}
